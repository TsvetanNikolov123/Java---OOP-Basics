...
public class Worker extends Human {
    ...
    private double workerSalaryPerHour() {
        double salary = this.weekSalary / (workHoursPerDay * 7);
    ...
    public String toString() {
        ...
        sb.append("First Name: ").append(this.getFirstName())
                ...
                .append(System.lineSeparator())
                .append("Salary per hour: ").append(String.format("%.2f", this.workerSalaryPerHour()));
//                .append(System.lineSeparator());
        return sb.toString();
    }
}
